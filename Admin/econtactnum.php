...
<body>
    ...
    <div class="content-container">
        <section class="search-section">
            <h2>SEARCH RESPONDER RECORDS</h2>
        ...
        <div class="table-wrapper">
            <table id="recordsTable">
                ...
                $sql_query = "SELECT * FROM admin WHERE role = 'Responder'";
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <button type="button" id ="btn-success" class="btn btn-success" style="height:40px" onclick="editRow(this)">Edit</button><br><br>
                            <button type="button" id ="btn-success" class="btn btn-danger" style="height:40px" onclick="deleteRow(<?= $row['id'] ?>)">Delete</button><br><br>
                        </td>
                    </tr>
                <?php
                }
