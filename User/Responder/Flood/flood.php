...
<head>
    ...
    <script>
        ...
        function updateNotificationStatus() {
            ...
            xhr.open("POST", "update_notification_status3.php", true); // Create a new PHP file for this
...
<body>
        ...
        <div class="header-container">
            ...
            <div class="notification-bell" onclick="toggleDropdown()">
                ...
                <span id="notification-count" style="color: red;">
                    ...
                    $count_sql = "SELECT COUNT(*) as count FROM floodreport WHERE active = 1";
                ...
                <div class="notification-dropdown" id="notificationDropdown">
                    <?php
                    // Fetch notifications from the floodreport table
                    $sql = "SELECT * FROM floodreport WHERE active = 1 ORDER BY date_time DESC LIMIT 5"; // Adjust the query as needed
    ...
    <center>
        <h1><i>GREETINGS<br>OFFICIALS!</i></h1>
        ...
        <form action="../see-report.php" method="post">
            <input type="submit" name="seeflood" class="report-btn" value="SEE REPORT">
            <br><br> 
        </form>
        <form action="../../logout.php" method="post">
            <input type="submit" class="login-btn" name="submit" value="LOGOUT">
        </form>
    </center>
    <footer>
