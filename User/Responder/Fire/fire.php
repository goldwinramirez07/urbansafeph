...
<body>
        ...
        <div class="header-container">
            ...
            <div class="notification-bell" onclick="toggleDropdown()">
                ...
                <span id="notification-count" style="color: red;">
                    ...
                    $count_sql = "SELECT COUNT(*) as count FROM firereport WHERE active = 1";
                ...
                <div class="notification-dropdown" id="notificationDropdown">
                    ...
                    $sql = "SELECT * FROM firereport WHERE active = 1 ORDER BY date_time DESC LIMIT 5"; // Adjust the query as needed
    ...
    <center>
        <h1><i>GREETINGS<br>FIREFIGHTER!</i></h1>
        ...
        <form action="../see-report.php" method="post">
            <input type="submit" name="seefire" class="report-btn" value="SEE REPORT">
            <br><br> 
        </form>
