...
<head>
    ...
    <script>
        ...
        function updateNotificationStatus() {
            ...
            xhr.open("POST", "../../../update_notification_status1.php", true); // Create a new PHP file for this
...
<body>
        ...
        <div class="header-container">
            ...
            <div class="notification-bell" onclick="toggleDropdown()">
                ...
                <span id="notification-count" style="color: red;">
                    ...
                    $count_sql = "SELECT COUNT(*) as count FROM crimereport WHERE active = 1";
                ...
                <div class="notification-dropdown" id="notificationDropdown">
                    ...
                    $sql = "SELECT * FROM crimereport WHERE active = 1 ORDER BY date_time DESC LIMIT 5"; // Adjust the query as needed
    ...
    <center>
        ...
        <form action="../see-report.php" method="post">
            <input type="submit" name="seepolice" class="report-btn" value="SEE REPORT">
            <br><br> 
        </form>
