...
<div class="report-container">
    <div class="report-box">
        <h1>REPORT FLOOD<br>INCIDENT</h1>
        <form action="flood-report-process.php" method="POST" enctype="multipart/form-data" id="reportForm">
        ...
        <div class="input-group"> 
            ...
            <input type="submit" class="report-btn" id="submitBtn" name="submit" value="SUBMIT" disabled>
...
<script>
     accessToken = "pk.48bd57a4d2ce4be8c7542cc52bbc98ea"; // Your LocationIQ access token
