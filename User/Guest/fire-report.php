...
<body>
    ...
    <div class="report-container">
        <div class="report-box">
            <h1>REPORT FIRE<br>INCIDENT</h1>
            <form action="fire-report-process.php" method="POST" enctype="multipart/form-data" id="reportForm">
                ...
                <div class="input-group"> 
                    ...
                    <input type="submit" class="register-btn" id="submitBtn" name="submit" value="SUBMIT" disabled>
